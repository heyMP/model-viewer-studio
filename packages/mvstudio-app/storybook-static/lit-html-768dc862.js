 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const C=new class{handleAttributeExpressions(e,t,n,s){const i=t[0];if("."===i){return new S(e,t.slice(1),n).parts}return"@"===i?[new V(e,t.slice(1),s.eventContext)]:"?"===i?[new N(e,t.slice(1),n)]:new x(e,t,n).parts}handleTextExpression(e){return new w(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const L=(e,...t)=>new f(e,t,"html",C)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function P(e,t){const{element:{content:n},parts:s}=e,i=document.createTreeWalker(n,133,null,!1);let o=B(s),r=s[o],l=-1,a=0;const d=[];let c=null;for(;i.nextNode();){l++;const e=i.currentNode;for(e.previousSibling===c&&(c=null),t.has(e)&&(d.push(e),null===c&&(c=e)),null!==c&&a++;void 0!==r&&r.index===l;)r.index=null!==c?-1:r.index-a,o=B(s,o),r=s[o]}d.forEach(e=>e.parentNode.removeChild(e))}const W=e=>{let t=11===e.nodeType?0:1;const n=document.createTreeWalker(e,133,null,!1);for(;n.nextNode();)t++;return t},B=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(h(t))return n}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const F=(e,t)=>`${e}--${t}`;let H=!0;void 0===window.ShadyCSS?H=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),H=!1);const I=e=>t=>{const n=F(t.type,e);let s=$.get(n);void 0===s&&(s={stringsArray:new WeakMap,keyString:new Map},$.set(n,s));let i=s.stringsArray.get(t.strings);if(void 0!==i)return i;const o=t.strings.join(r);if(i=s.keyString.get(o),void 0===i){const n=t.getTemplateElement();H&&window.ShadyCSS.prepareTemplateDom(n,e),i=new d(t,n),s.keyString.set(o,i)}return s.stringsArray.set(t.strings,i),i},j=["html","svg"],O=new Set,q=(e,t,n)=>{O.add(e);const s=n?n.element:document.createElement("template"),i=t.querySelectorAll("style"),{length:o}=i;if(0===o)return void window.ShadyCSS.prepareTemplateStyles(s,e);const r=document.createElement("style");for(let e=0;e<o;e++){const t=i[e];t.parentNode.removeChild(t),r.textContent+=t.textContent}(e=>{j.forEach(t=>{const n=$.get(F(t,e));void 0!==n&&n.keyString.forEach(e=>{const{element:{content:t}}=e,n=new Set;Array.from(t.querySelectorAll("style")).forEach(e=>{n.add(e)}),P(e,n)})})})(e);const l=s.content;n?function(e,t,n=null){const{element:{content:s},parts:i}=e;if(null==n)return void s.appendChild(t);const o=document.createTreeWalker(s,133,null,!1);let r=B(i),l=0,a=-1;for(;o.nextNode();){for(a++,o.currentNode===n&&(l=W(t),n.parentNode.insertBefore(t,n));-1!==r&&i[r].index===a;){if(l>0){for(;-1!==r;)i[r].index+=l,r=B(i,r);return}r=B(i,r)}}}(n,r,l.firstChild):l.insertBefore(r,l.firstChild),window.ShadyCSS.prepareTemplateStyles(s,e);const a=l.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==a)t.insertBefore(a.cloneNode(!0),t.firstChild);else if(n){l.insertBefore(r,l.firstChild);const e=new Set;e.add(r),P(n,e)}},D=(e,t,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const i=n.scopeName,o=k.has(t),r=H&&11===t.nodeType&&!!t.host,l=r&&!O.has(i),a=l?document.createDocumentFragment():t;if(M(e,a,Object.assign({templateFactory:I(i)},n)),l){const e=k.get(a);k.delete(a);const n=e.value instanceof m?e.value.template:void 0;q(i,a,n),s(t,t.firstChild),t.appendChild(a),k.set(t,e)}!o&&r&&window.ShadyCSS.styleElement(t.host)};export{f as T,D as a,L as h,M as r};
//# sourceMappingURL=lit-html-768dc862.js.map
